...
urlpatterns = [
    ...
    path("integracoes/festas/previa/", integ.PreviaFestaView.as_view(), name="api_festa_previa"),
    path("integracoes/festas/importar/", integ.ImportarFestaView.as_view(), name="api_festa_importar"),
    path("integracoes/produtos-planilha/previa/", integ.PreviaControleProdutosView.as_view(),
         name="api_controle_produtos_previa"),
    path("integracoes/produtos-planilha/importar/", integ.ImportarControleProdutosView.as_view(),
         name="api_controle_produtos_importar"),
